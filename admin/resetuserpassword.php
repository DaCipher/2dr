                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php if (empty($search)) { ?>
                                            ...
                                            <form action="resetuserpassword.php" class="my-3" method="post">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <form action="resetuserpassword.php" method="post">
                                                ...
                                                <input type="submit" name="submit" value="Change Password" class="btn btn-primary form-control" required minlength="8">
                                            </form>
                                        <?php } ?>
                                    </div>
                                </div>
