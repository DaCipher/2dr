...
// Disable
$status = $status_search = $error = $search = $pass1_err = $pass2_err = $username_err =  $disabled = '';
...
if (isset($_POST['search'])) {
  ...
  <strong>Error: </strong> Non Admin Account!
...
if (isset($_POST['submit'])) {
    ...
    if (empty($input_pass1)) {
        ...
        $pass1_err = "Minimum of 5 characters required!";
        $error = "set";
        $search = "set";
    } else {
        $search = 'set';
    ...
    if (empty($error)) {
        $sql = $conn->query("update users set password ='" . $password . "' where username = '" . $_POST['username'] . "'");
        if ($sql) {
            $search = '';
...
<head>
    ...
    <title>Reset Admin Password - Smart Admin</title>
                                ...
                                <div class="d-flex align-items-end flex-wrap">
                                    ...
                                    <div class="mr-md-3 mr-xl-5">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <p class="text-primary mb-0 hover-cursor">Password Reset</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mx-auto">
                            <div class="shadow">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-center">Reset User Password</h5>
                                        <?php if (empty($search)) { ?>
                                            <?php echo $status_search; ?>
                                            <form action="resetadminpassword.php" class="my-3" method="post">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <form action="resetadminpassword.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="pass1" id="" class="form-control" required minlength="5">
                                                    <span class="help-block text-danger"><?php echo $pass1_err; ?></span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pass2">Confirm Password</label>
                                                    <input type="password" name="pass2" id="pass2" class="form-control" required minlength="5">
