...
<head>
    ...
    <title>Account Funding- SmartFXCrypto</title>
                                    ...
                                    <div class="mr-md-3 mr-xl-5">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <p class="text-muted mb-0 hover-cursor">
                                                &nbsp;/&nbsp;Transaction&nbsp;/&nbsp;</p>
                                            <p class="text-danger mb-0 hover-cursor">Funding</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btn-wrap">
                                            <form action="" method="post" id="basic_plan" class="my-2 text-center">
                                                <input type="number" name="basic_amount" class="form-control mb-2" placeholder="Enter Amount" id="basic_amount" min="500" max="999" required>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center text-danger" id="paymentLabel"><i class="mdi mdi-lock"></i> Secure Payment</h5>
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <p>You selected the <span id="plan" class="font-weight-bold"></span> plan.</p>
                                    <p>Please send the bitcoin eqivalent of <span class="text-danger font-weight-bold" id="amount"></span> to your unique adddress below:</p>
                                    <div class="input-group my-4">
                                        <input type="text" name="" id="wallet" class="form-control py-1 border" style="background-color: rgb(233, 233, 233); padding-bottom: 0;;" readonly value="<?php echo $info['wallet']; ?>">
                                        <div class="input-append"><button class="btn btn-outline-primary py-3" id="copy_btn">Copy</button>

                                        </div>
                                    </div>
                                    <p>Payments are processed within 4 hours.<br /> Should your transaction take more than the ussual, please contact support team on <a href="mailto:support@fxtrade-iq.com">support@fxtrade-iq.com</a>.
                                    </p>
                                </div>
